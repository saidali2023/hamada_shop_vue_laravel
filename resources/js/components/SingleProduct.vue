                    ...
                    <div class="row">
                            ...
                            <div class="product-gallery product-gallery-vertical">
                                <div class="row">
                                    <figure class="product-main-image">
                                        <img id="product-zoom" :src="post.product_image[0]['image']"  data-zoom-image="assets/images/products/single/1-big.jpg" alt="product image">
                                    ...
                                    <div id="product-zoom-gallery" class="product-image-gallery">
                                      ...
                                      <a v-for="pro_img in post.product_image"  class="product-gallery-item active" href="#" data-image="assets/images/products/single/1.jpg" data-zoom-image="assets/images/products/single/1-big.jpg">
                                          <img :src="pro_img.image" alt="product side">
                                      </a>
                                      <a v-for="pro_img in post.product_image"  class="product-gallery-item active" href="#" data-image="assets/images/products/single/1.jpg" data-zoom-image="assets/images/products/single/1-big.jpg">
                                          <img :src="pro_img.image" alt="product side">
                                      </a>
                        ...
                        <div class="col-md-6">
                            <div class="product-details">
                                <h1 class="product-title">{{post.name}}</h1><!-- End .product-title -->
...
export default {
   ...
   mounted() {
      ...
      this.$toaster.error('Your toaster success message.');
      this.$toaster.warning('Your toaster success message.');
      this.$toaster.info('Your toaster success message.');
   },
   methods:{
     getPost(){
      axios.get('https://elnamat.com/poems/eshop/api/buyers/product-details?productId='+this.$route.params.id)
      .then(res =>{
        // console.log(res)
