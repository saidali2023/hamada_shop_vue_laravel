                		...
                		<div class="col-lg-9">
                            ...
                            <div class="products mb-3">
                                <div class="row justify-content-center">
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3" v-for="product in products.data" :key="product.id">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    ...
                                                    <a href="#" class="active" v-for="pro_img in product.product_image">
                                                        <img :src="pro_img.image" alt="product desc">
                                                    </a>
                                                    <a href="#" class="active" v-for="pro_img in product.product_image">
                                                        <img :src="pro_img.image" alt="product desc">
                                                    </a>
